...
@section('content')
    <div id="breadcrumb"><a href="{{url('/admin')}}" title="Ana Sayfaya Git" class="tip-bottom"><i class="icon-home"></i>
            Ana Sayfa</a> <a href="{{route('product.index')}}">Ürünler</a> <a href="#" class="current">Resim Ekle</a></div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('image-gallery.store')}}" method="post" role="form"
                                      enctype="multipart/form-data">
                                    <legend>Birden fazla resim ekleyebilirsiniz</legend>
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <div class="form-group">
                                        <input type="hidden" name="products_id" value="{{$product->id}}">
                                        <input type="file" name="image[]" id="id_imageGallery" class="form-control"
                            ...
                            @foreach($imageGalleries as $imageGallery)
                                <tr>
                                    ...
                                    <td class="taskOptions" style="text-align: center;vertical-align: middle;"><img
                                                src="{{url('products/small',$imageGallery->image)}}"
                                                class="img-responsive" alt="Image" width="60"></td>
                                    <td style="text-align: center;vertical-align: middle;"><a href="javascript:"
                                                                                              rel="{{$imageGallery->id}}"
                                                                                              rel1="delete-imageGallery"
