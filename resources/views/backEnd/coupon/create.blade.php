...
@section('content')
    <div id="breadcrumb"><a href="{{url('/admin')}}" title="Ana sayfaya git" class="tip-bottom"><i class="icon-home"></i>
            Ana Sayfa</a> <a href="{{route('coupon.index')}}">Kuponlar</a> <a href="{{route('coupon.create')}}"
                                                                        class="current">Yeni Kupon Ekle</a></div>
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.store')}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('amount')?' has-error':''}}">
                            <input type="number" min="0" name="amount" id="amount" class="form-control"
                                   value="{{old('amount')}}" title="" required="required" style="width: 400px;">
                            ...
                            <div class="input-prepend">
                                <div data-date="12-02-2012" class="input-append date datepicker">
                                    <input type="text" name="expiry_date" id="expiry_date"
                                           value="{{old('expiry_date')}}" data-date-format="yyyy-mm-dd" class="span11"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Yeni Kupon Ekle</button>
                        </div>
                    </div>
                </form>
            </div>
