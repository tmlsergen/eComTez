...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('product.create')->with('message', 'Ürün Ekleme İşlemi Başarılı!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('message', 'Ürün Güncellendi!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('product.index')->with('message', 'Ürün Silindi!');
    }
