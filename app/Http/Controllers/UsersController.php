...
//    {
//        $this->middleware('auth')->except(['logout','account','updateprofile','updatepassword']);
//    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['email' => $input_data['email'], 'password' => $input_data['password']])) {
            ...
            return back()->with('message', 'Giriş Bilgileriniz hatalı!');
        }
    }
    ...
    public function updateprofile(Request $request, $id)
    {
        ...
        return back()->with('message', 'Profiliniz Güncellendi!');
    ...
    public function updatepassword(Request $request, $id)
    {
        ...
        if (Hash::check($input_data['password'], $oldPassword->password)) {
            ...
            return back()->with('message', 'Şifreniz Güncellendi!');
        } else {
            return back()->with('oldpassword', 'Şifreniz Doğru değil!');
        }
    }
}
